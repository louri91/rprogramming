...
### 2. Dado que lo que queremos encontrar es un límite superior e inferior de tal manera que aproximadamente el 95% de las estimaciones estén dentro de estos límites. Una forma de obtener un IC del 95% es encontrar el percentil 2,5 y el percentil 97,5 de la distribución de Monte Carlo.
